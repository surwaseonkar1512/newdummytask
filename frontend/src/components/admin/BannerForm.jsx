    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-gray-900/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex justify-between items-center p-5 border-b border-gray-100 flex-shrink-0 bg-white z-10">
          <h2 className="text-xl font-bold text-gray-900">{banner ? 'Edit Banner' : 'Add New Banner'}</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="p-6 overflow-y-auto flex-1">
            <div className="space-y-6">
              ...
              {/* Image Selector */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Banner Image <span className="text-red-500">*</span></label>
                <div 
              ...
              <div className="grid grid-cols-1 gap-5">
                <div>
                  ...
                  <input 
                    ...
                    className={`w-full px-4 py-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-purple-200 transition-colors ${errors.heading ? 'border-red-500 bg-red-50' : 'border-gray-300 focus:border-purple-500 bg-gray-50'}`}
                    placeholder="E.g., Masterpieces Crafted With Soul"
                  />
                  {errors.heading && <p className="text-red-500 text-xs mt-1 font-medium">{errors.heading.message}</p>}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 items-center">
                  <div>
                    ...
                    <input 
                      ...
                      {...register('ctaText')}
                      className="w-full px-4 py-2.5 border border-gray-300 rounded-lg outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 bg-gray-50 transition-colors"
                      placeholder="E.g., Explore Gallery"
                    />
                  </div>
                  <div className="pt-6 px-4">
                    <label className="flex items-center cursor-pointer">
                      ...
                      <span className="ml-3 text-sm font-medium text-gray-700">Display Banner Active</span>
                    </label>
                  </div>
                </div>
              </div>
      ...
      <GalleryModal 
        ...
        onSelect={(img) => { setSelectedImage(img); setShowGallery(false); }} 
      />
    </div>
  );
};
